...
from topic_pulse_v2.topics.hotspot import (
...
class HotspotAgent:
    ...
    ) -> list[NormalizedHotNewsItem]:
        normalized: list[NormalizedHotNewsItem] = []
    ...
    def _fallback_analysis(
        ...
        groups: list[tuple[list[NormalizedHotNewsItem], str]] = []
        for item in items:
            matched_index = None
