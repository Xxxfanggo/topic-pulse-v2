...
<p align="center">
  ...
  ·
  <a href="docker_README.md">Docker</a>
  ·
...
体验地址：[https://424tp5kz9617.vicp.fun/chat](https://424tp5kz9617.vicp.fun/chat)
...
Docker 构建、运行、持久化和 Nginx 反向代理说明已拆分到 [docker_README.md](docker_README.md)。
